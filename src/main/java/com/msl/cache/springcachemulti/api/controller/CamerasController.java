...
//	}
	...
	public Optional<Camera> getById(@PathVariable String id) {
		LOGGER.info("Finding camerasid by id..." + id);
		return service.findById(id);
	}

	@GetMapping(path = "/cameras", produces = "application/json")
	public Optional<Camera> get(@RequestParam String country, @RequestParam String installation, @RequestParam String zone) {
